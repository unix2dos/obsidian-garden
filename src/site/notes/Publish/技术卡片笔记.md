---
{"aliases":[],"tags":[],"title":"技术卡片笔记","date":"2025-06-01T07:55:23+08:00","date_modify":"2025-07-20T16:55:53+08:00","dg-publish":true,"permalink":"/Publish/技术卡片笔记/","dgPassFrontmatter":true,"created":"2025-06-01T07:55:23+08:00","updated":"2025-07-20T16:55:53+08:00"}
---
...
```bash
git diff HEAD -- ':!library/.obsidian/plugins' | /opt/anaconda3/bin/sgpt '根据更改生成 git 提交信息：要求：1.遵循 git 提交最佳实践 2.使用
中文直接输出，无需解释 3. 语言精简一些,只描述重点修改,省略不重要信息 4.每条信息前加序号'
```
