---
{"aliases":[],"tags":[],"title":"技术卡片笔记","date":"2025-06-01T07:55:23+08:00","date_modify":"2025-07-19T18:01:32+08:00","dg-publish":true,"permalink":"/Publish/技术卡片笔记/","dgPassFrontmatter":true,"created":"2025-06-01T07:55:23+08:00","updated":"2025-07-19T18:01:32+08:00"}
---


# 2025-07-19 Obsidian git 生成 ai commit

放到 Commit message script

```bash
git diff HEAD -- ':!library/.obsidian/plugins' | /opt/anaconda3/bin/sgpt '为我的更改生成git提交消息，使用git提交最佳实践，不要添加前言和解释，直接输出提交内容，每条前面加一个序号, 并用中文输出'
```
