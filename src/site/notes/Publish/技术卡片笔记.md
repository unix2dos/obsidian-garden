---
{"aliases":[],"tags":[],"title":"技术卡片笔记","date":"2025-06-01T07:55:23+08:00","date_modify":"2025-07-19T00:42:18+08:00","dg-publish":true,"permalink":"/Publish/技术卡片笔记/","dgPassFrontmatter":true,"created":"2025-06-01T07:55:23+08:00","updated":"2025-07-19T00:42:18+08:00"}
---


# 2025-07-19 Watch 命令

`watch -n 1` 是一个 Linux/Unix 命令，用于**每隔 1 秒重复执行一次后面的命令**，并实时显示输出结果。
...
- 你的业务逻辑层 (`fetchUserData` 函数) 或数据访问层 (DAO) 的职责是**处理业务**，它根本不应该，也不需要知道什么是 HTTP，什么是 JSON 响应，什么是 Gin 框架。
