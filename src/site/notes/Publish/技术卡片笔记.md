---
{"aliases":[],"tags":[],"title":"技术卡片笔记","date":"2025-06-01T07:55:23+08:00","date_modify":"2025-12-03T13:05:58+08:00","dg-publish":true,"permalink":"/Publish/技术卡片笔记/","dgPassFrontmatter":true,"created":"2025-06-01T07:55:23+08:00","updated":"2025-12-03T13:05:58+08:00"}
---


# 2025-12-03 Google Gemini 验证

- <https://linux.do/t/topic/1235733>
- <https://x.com/TokenXbs/status/1994394421685793035>
...
# 2025-12-02 MT7986A 和瑞芯微 Rk3566 对比

MT7986A 是为路由器和网络设备而生的 " 特种兵 "，而 RK3566 是为电视盒子、平板和多媒体设备设计的 " 全能手 "。

1. **MT7986A** 是专业的**网络/路由器芯片**，强调网络吞吐、硬件 NAT 加速、WiFi 6/6E 支持，适合路由器、网关设备
2. **RK3566** 是通用**应用处理器**，强调图形显示、多媒体、AI 推理能力，适合平板、显示终端、智能设备

- MT7986A (Filogic 830):
	- 架构： 4 核 ARM Cortex-A53
	- 主频： 最高 2.0 GHz
	- 工艺： 12nm (更先进，发热更低，能效比更好)
	- 评价： 虽然使用的是较老的 A53 架构，但 2.0GHz 的高主频加上 12nm 工艺，保证了其在网络数据吞吐处理上的强大和稳定。
- RK3566:
	- 架构： 4 核 ARM Cortex-A55
	- 主频： 通常为 1.8 GHz
	- 工艺： 22nm
	- 评价： A55 是 A53 的升级版，同频率下性能提升约 15%-20%。虽然主频略低（1.8G），但得益于架构优势，两者的纯 CPU 运算能力（算力）在体感上是半斤八两的，RK3566 的单核效率略高一筹。

# 2025-12-02 Openwrt 流量统计

- `luci-app-nlbwmon` 是目前兼容性最好、功能最平衡的选择。它可以按 MAC 地址、IP 地址统计流量，涵盖小时、天、周、月等不同时间段。
- <https://github.com/timsaya/luci-app-bandix>	流量统计插件，代替 nlbwmon、bandwidthd，建议 github 自行安装

```bash
root@ImmortalWrt:~# uname -a
Linux ImmortalWrt 6.6.95 #0 SMP Fri Aug 29 14:14:32 2025 aarch64 GNU/Linux

后端：CPU 核心优化 (cortex-a53)：bandix_0.10.2-r1_aarch64_cortex-a53.ipk
前端：luci-app-bandix_0.10.2-r1_all.ipk

# 安装
scp ~/Downloads/bandix_0.10.2-r1_aarch64_cortex-a53.ipk root@openwrt:/root
scp ~/Downloads/luci-app-bandix_0.10.2-r1_all.ipk root@openwrt:/root
opkg install ./bandix_0.10.2-r1_aarch64_cortex-a53.ipk  
opkg install ./luci-app-bandix_0.10.2-r1_all.ipk

# 去openwrt -> 网络 ->  Banix 流量监控里查看
```
