---
{"aliases":[],"tags":[],"title":"技术卡片笔记","date":"2025-06-01T07:55:23+08:00","date_modify":"2026-01-16T00:31:39+08:00","dg-publish":true,"permalink":"/Publish/技术卡片笔记/","dgPassFrontmatter":true,"created":"2025-06-01T07:55:23+08:00","updated":"2026-01-16T00:31:39+08:00"}
---
...
- `fzf` 默认是列出当前目录下的**文件名**。如果你想搜内容，需要配合 `ripgrep` 或 `grep` 使用。
- 安装好 fzf 后，默认脚本会开启 **`Ctrl + R`**。这是神技！直接在终端按这个组合键，瞬间搜索你那几千条历史命令。
